...
| [Context and Mentions](context-and-mentions.md)             | Active note context, attachments, @-mentions, URLs, tags, and the web viewer    |
...
| [Agent Mode and Tools](agent-mode-and-tools.md)             | Autonomous agent, all 14 tools, file editing, web search                        |
